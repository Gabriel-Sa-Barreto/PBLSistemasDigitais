...
module nios_mm_interconnect_0 (
	...
	wire  [93:0] pushbutton_s1_agent_rf_source_data;                                          // pushButton_s1_agent:rf_source_data -> pushButton_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pushbutton_s1_agent_rsp_fifo_out_data;                                       // pushButton_s1_agent_rsp_fifo:out_data -> pushButton_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> pushButton_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> pushButton_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // pushButton_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> pushButton_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> pushButton_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> pushButton_s1_agent:cp_endofpacket
	...
	wire  [92:0] pushbutton_s1_agent_rp_data;                                                 // pushButton_s1_agent:rp_data -> router_005:sink_data
	...
	wire         pushbutton_s1_agent_rdata_fifo_src_valid;                                    // pushButton_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pushbutton_s1_agent_rdata_fifo_src_data;                                     // pushButton_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pushbutton_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_003:in_0_ready -> pushButton_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> pushButton_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> pushButton_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                           // pushButton_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> pushButton_s1_agent:rdata_fifo_sink_error
