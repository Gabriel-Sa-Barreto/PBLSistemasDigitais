...
module nios_mm_interconnect_0 (
	...
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> pushButton_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> pushButton_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // pushButton_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> pushButton_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> pushButton_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> pushButton_s1_agent:cp_endofpacket
	...
	wire         pushbutton_s1_agent_rp_valid;                                                // pushButton_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] pushbutton_s1_agent_rp_data;                                                 // pushButton_s1_agent:rp_data -> router_006:sink_data
	wire         pushbutton_s1_agent_rp_ready;                                                // router_006:sink_ready -> pushButton_s1_agent:rp_ready
	wire         pushbutton_s1_agent_rp_startofpacket;                                        // pushButton_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pushbutton_s1_agent_rp_endofpacket;                                          // pushButton_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
