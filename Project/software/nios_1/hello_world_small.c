...
/*Publish = (tipo) + (tamanho do pacote) + (0x00)+ (tamanho do tópico) + (tópico) + (mensagem)*/

/*Pacotes de mensagem do menu*/
...
/*Pacotes de mensagens do sensores e alarme*/
char publishSensor[] = {0x30,0x0F,0x00,0x07,0x4D,0x45,0x44,0x49,0x43,0x41,0x47,0x53,0x45,0x4E,0x53,0x47,0x52,'',0x5F,0xAF,''};
char publishAlarme[] = {0x30,0x0F,0x00,0x07,0x4D,0x45,0x44,0x49,0x43,0x41,0x47,0x41,0x4C,0x41,0x52,0x4D,0x45};
char comandoSendPSensor[] = "AT+CIPSEND=21";
char comandoSendPAlarme[] = "AT+CIPSEND=17";

/*Sensores*/
char S1 = 0x01 , S2 = 0x01, S3 = 0x01, S4 = 0x01, S5 = 0x01;
